...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const initialPage = location.hash ? location.hash.substring(1) : '../../HTML/staff-ui/staff-frontdesk-subfolder/staff-frontdesk-dashboard.html';
  ...
  window.addEventListener("popstate", (event) => {
    if (event.state && event.state.pageUrl) {
      ...
      loadPage('../../HTML/staff-ui/staff-frontdesk-subfolder/staff-frontdesk-dashboard.html', false);
    }
  });
});
