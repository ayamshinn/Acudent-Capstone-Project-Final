...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const initialPage = location.hash ? location.hash.substring(1) : '../../HTML/staff-ui/staff-assistant-subfolder/staff-assistant-dashboard.html';
  ...
  window.addEventListener("popstate", (event) => {
    if (event.state && event.state.pageUrl) {
      ...
      loadPage('../../HTML/staff-ui/staff-assistant-subfolder/staff-assistant-dashboard.html', false);
    }
  });
});
...
function initPageScript(pageUrl) {
  if (pageUrl.includes('staff-assistant-my-account.html')) {
  ...
  if (pageUrl.includes('staff-assistant-dashboard.html')) {
  ...
  if (pageUrl.includes('staff-assistant-patient-records.html')) {
  ...
  if (pageUrl.includes('staff-assistant-appointments.html')) {
  ...
  if (pageUrl.includes('staff-assistant-messages.html')) {
  ...
  if (pageUrl.includes('staff-assistant-inventory-management.html')) {
  ...
  if (pageUrl.includes('staff-assistant-help.html')) {
  ...
  if (pageUrl.includes('staff-assistant-patient-records-detailed.html')) {
