...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const initialPage = location.hash ? location.hash.substring(1) : '../../HTML/patient-ui/patient-subfolder/patient-dashboard.html';
  ...
  window.addEventListener("popstate", (event) => {
    if (event.state && event.state.pageUrl) {
      ...
      loadPage('../../HTML/patient-ui/patient-subfolder/patient-dashboard.html', false);
    }
  });
});
