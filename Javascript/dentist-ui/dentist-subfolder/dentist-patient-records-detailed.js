  ...
  if (!page) return;
    ...
    if (backBtn) {
        backBtn.addEventListener('click', () => {
            const url = backBtn.getAttribute('data-target') || '../../HTML/dentist-ui/dentist-subfolder/dentist-patient-records-detailed.html';
...
document.addEventListener('DOMContentLoaded', initDentistPatientRecordsDetailed);
