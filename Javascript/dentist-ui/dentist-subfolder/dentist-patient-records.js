function initDentistPatientRecords() {
    const page = document.querySelector('#dentist-patient-page-id');
  if (!page) return;
...
document.addEventListener('DOMContentLoaded', initDentistPatientRecords);
